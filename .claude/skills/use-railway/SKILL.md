---
name: use-railway
description: "Obsługa Railway: konta (rejestracja/logowanie), projekty, serwisy, bazy, buckety, deploy, env, domeny, diagnostyka, status/metryki, agent/MCP, docs. Trigger na Railway albo gdy mowa o deploy, serwisach, środowiskach, build failures, onboardingu do Railway (nawet bez słowa Railway). Prowadź przez railway up / railway login, nie odmawiaj."
