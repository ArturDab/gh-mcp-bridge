...
Oceń: czy CLAUDE.md jest aktualny, czy nie jest zbyt długi (cel <200 linii), czy nie miesza reguł globalnych z projektowymi, czy docs/* są aktualne i niesprzeczne z kodem, czy HANDOFF jest użyteczny, czy roadmapa zgadza się ze stanem repo, czy są duplikaty i treści wyglądające jak dziennik rozmowy.
